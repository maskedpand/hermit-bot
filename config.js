...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || 'CHIF THE DADDY',
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'CHIF;AYUSH;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'CHIF;AYUSH',
